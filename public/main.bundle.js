...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__services_validation_service__ = __webpack_require__("../../../../../src/app/services/validation.service.ts");
...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            providers: [
                __WEBPACK_IMPORTED_MODULE_12__services_validation_service__["a" /* ValidationService */],
...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.loginUser(user)
            ...
            if (!data.success) {
                _this.flashMessagesService.show('Login Failed.', { cssClass: 'alert alert-danger' });
                return false;
            }
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function (e) {
        ...
        this.authService.registerUser(user)
            .subscribe(function (data) {
            if (data.success) {
                _this.flashMessagesService.show('User registered.', {
                    'cssClass': 'alert alert-success'
                });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessagesService.show('User registration failed.', {
                    'cssClass': 'alert alert-danger'
                });
            }
        });
    ...
    RegisterComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            providers: [
                __WEBPACK_IMPORTED_MODULE_1__services_validation_service__["a" /* ValidationService */]
            ]
        }),
...
var ValidationService = (function () {
    ...
    ValidationService.prototype.validateRegistration = function (user) {
